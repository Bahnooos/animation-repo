...
class RiveSliderAnimation extends StatefulWidget {
  const RiveSliderAnimation({super.key});
  static const screenRoute = 'Rive Slider Animation';

  @override
  State<RiveSliderAnimation> createState() => _LottieSliderAnimationState();
}

class _LottieSliderAnimationState extends State<RiveSliderAnimation> {
